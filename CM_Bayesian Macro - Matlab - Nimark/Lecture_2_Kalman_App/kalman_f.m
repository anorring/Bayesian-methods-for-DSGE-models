function [K,P]=kalman_filter_simulator(A,C,D,R,periods)
%Simulates state space and compute Kalman filter for state space system
% 	X[t] = AX[t-1] + Cu[t]
% 
%   Z[t] = DX[t] + Ru[t]
%
